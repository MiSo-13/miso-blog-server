...
AI는 저장된 URL의 본문을 직접 읽지 않습니다. 그래서 URL만 넣으면 AI가 그 링크의 내용을 정확히 알 수 없습니다. `description`에 “이 링크를 왜 참고해야 하는지”를 적어두면 훨씬 좋은 글이 나옵니다.
...
> 레퍼런스 URL은 AI가 글을 쓸 때 참고하는 링크입니다. URL 본문을 자동으로 읽지는 않으니, 어떤 점을 참고해야 하는지 설명을 함께 적어주세요.

> 지금 활성화된 레퍼런스 URL이 AI 초안과 수정 요청에 함께 전달됩니다. 이번 글과 관련 없는 링크는 잠시 비활성화해두면 더 정확한 결과를 얻을 수 있습니다.
